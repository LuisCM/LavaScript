// ================================================================================================
// -*- C++ -*-
// File: ls_symbol_table.hpp
// Author: LuisCM
// Created on: 24/08/2001
// Brief: Defines the Symbol type and a Symbol Table.
// ================================================================================================

#ifndef LAVASCRIPT_SYMBOL_TABLE_HPP
#define LAVASCRIPT_SYMBOL_TABLE_HPP
...
class LSSymbolTable final
    : public LSRegistry<const Symbol *>
{
public:
...
private:
    ...
    LSPool<Symbol, LAVASCRIPT_SYMBOL_POOL_GRANULARITY> symbolPool;
};

inline std::ostream & operator << (std::ostream & os, const LSSymbolTable & symTable)
{
    symTable.print(os);
    return os;
}
...
#endif // LAVASCRIPT_SYMBOL_TABLE_HPP
