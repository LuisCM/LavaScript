// ================================================================================================
// -*- C++ -*-
// File: ls_syntax_tree.hpp
// Author: LuisCM
// Created on: 24/08/2001
// Brief: Syntax Tree definition.
// ================================================================================================

#ifndef LAVASCRIPT_SYNTAX_TREE_HPP
#define LAVASCRIPT_SYNTAX_TREE_HPP
...
struct SyntaxTreeNode final
{
    ...
    {
        LAVASCRIPT_ASSERT(index >= 0 && index < 3);
    ...
    {
        LAVASCRIPT_ASSERT(index >= 0 && index < 3);
        LAVASCRIPT_ASSERT(children[index] != nullptr);
...
class LSSyntaxTree final
{
public:

    LSSyntaxTree() = default;
    LSSyntaxTree(const LSSyntaxTree &) = delete;
    LSSyntaxTree & operator = (const LSSyntaxTree &) = delete;
    ...
    // the function throws with LAVASCRIPT_INTERNAL_EXCEPTION().
...
private:
    ...
    LSPool<SyntaxTreeNode, LAVASCRIPT_AST_NODE_POOL_GRANULARITY> nodePool;
};

inline std::ostream & operator << (std::ostream & os, const LSSyntaxTree & syntaxTree)
{
    syntaxTree.print(os);
    return os;
}
...
#endif // LAVASCRIPT_SYNTAX_TREE_HPP
